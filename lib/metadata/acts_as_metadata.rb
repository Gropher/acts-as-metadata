    ...
    if options[:scope].is_a?(Symbol) && options[:scope].to_s !~ /_id$/
      ...
      def metadata_constraints
        metadata_types.each do |type_name|
          ...
          type_format = type.attributes["format"]
          ...
          if value.is_a? Array
            ...
            value.each_with_index do |v, i|
              errors.add("#{type.tag}_#{i}", I18n.t('acts_as_metadata.errors.format')) if values.blank? && type_format.present? && v.present? && v.to_s !~ Regexp.new("\A#{type_format}\z")
            ...
            errors.add(type.tag, I18n.t('acts_as_metadata.errors.format')) if values.blank? && type_format.present? && value.present? && value.to_s !~ Regexp.new("\A#{type_format}\z")
